  ...
  <Box sx={{ flexGrow: 1 }}>
    <AppBar position="fixed" sx={{ boxShadow: 3 }}>
      <Toolbar>
        ...
        <Button color="inherit" component={RouterLink} to="/contracts">Контракты</Button>
        <Button color="inherit" component={RouterLink} to="/deliveries">Поставки</Button>
        <Button color="inherit" component={RouterLink} to="/payments">Платежи</Button>
        <Button color="inherit" component={RouterLink} to="/documents">Документы</Button>
