-- Скрипт для ручного применения миграций условий оплаты и доставки
-- Выполните этот скрипт в базе данных, если автоматические миграции не сработали

-- Создание таблицы условий оплаты
...
-- Создание таблицы частей платежа
...
-- Создание таблицы условий доставки
...
-- Добавление связей в таблицу предложений поставщиков
...
-- Вставка стандартных условий оплаты
...
-- Вставка частей платежа для стандартных условий
...
-- Вставка стандартных условий доставки
...
-- Проверка наличия новых колонок в supplier_proposals
